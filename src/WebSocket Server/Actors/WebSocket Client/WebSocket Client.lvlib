...
<Library LVVersion="17008000">
	...
	<Item Name="Abstract Messages for Caller" Type="Folder">
		<Item Name="New Message Msg.lvclass" Type="LVClass" URL="../WebSocket Client Messages/New Message Msg/New Message Msg.lvclass"/>
	</Item>
	<Item Name="Messages for this Actor" Type="Folder">
		<Item Name="Recieved Message Msg.lvclass" Type="LVClass" URL="../WebSocket Client Messages/Recieved Message Msg/Recieved Message Msg.lvclass"/>
		<Item Name="Send Message Msg.lvclass" Type="LVClass" URL="../WebSocket Client Messages/Send Message Msg/Send Message Msg.lvclass"/>
	</Item>
