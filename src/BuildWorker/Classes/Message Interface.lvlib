...
<Library LVVersion="17008000">
	...
	<Item Name="iMessage.lvclass" Type="LVClass" URL="../iMessage/iMessage.lvclass"/>
	<Item Name="Status.lvclass" Type="LVClass" URL="../Status/Status.lvclass"/>
	<Item Name="Task Outputs.lvclass" Type="LVClass" URL="../Task Outputs/Task Outputs.lvclass"/>
	<Item Name="Task Status.lvclass" Type="LVClass" URL="../Task Status/Task Status.lvclass"/>
	<Item Name="Worker Status.lvclass" Type="LVClass" URL="../Worker Status/Worker Status.lvclass"/>
</Library>
