...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support" Type="Folder">
			...
			<Item Name="Connection Handler.lvlib" Type="Library" URL="../../WebSocket Server/Actors/Connection Handler/Connection Handler.lvlib"/>
			<Item Name="Connection Listener.lvlib" Type="Library" URL="../../WebSocket Server/Actors/Connection Listener/Connection Listener.lvlib"/>
			<Item Name="WebSocket Client.lvlib" Type="Library" URL="../../WebSocket Server/Actors/WebSocket Client/WebSocket Client.lvlib"/>
			<Item Name="Framework.lvlib" Type="Library" URL="../../WebSocket Server/Actors/Actor wHelper/Framework.lvlib"/>
			<Item Name="Message Interface.lvlib" Type="Library" URL="../Classes/Message Interface.lvlib"/>
			<Item Name="Task Interface.lvlib" Type="Library" URL="../Classes/Task Interface.lvlib"/>
		</Item>
		<Item Name="BuildWorker Controller Tester.vi" Type="VI" URL="../BuildWorker Controller Tester.vi"/>
		<Item Name="BuildWorker Controller.lvlib" Type="Library" URL="../Classes/BuildWorker Controller/BuildWorker Controller.lvlib"/>
		<Item Name="BuildWorker Launcher.vi" Type="VI" URL="../BuildWorker Launcher.vi"/>
		<Item Name="BuildWorker Tester.vi" Type="VI" URL="../BuildWorker Tester.vi"/>
